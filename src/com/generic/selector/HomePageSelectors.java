...
public class HomePageSelectors
{
	...
	public static final cselector menuItems = new cselector("css,#css-top-navigation #flyout>.menuItem>a","css,.gwt-Anchor.gwt-MenuItem", "css,.navigation-modal_class .pw-link");
