...
public class HomePageSelectors
{
	...
	public static final cselector GHmenuItems = new cselector("css,.gwt-MenuItem a","css,.gwt-MenuBar a", "css,.m-accordion-navigation__content  div.pw-accordion__item > button");
