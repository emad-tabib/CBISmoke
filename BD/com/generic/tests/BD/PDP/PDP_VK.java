...
public class PDP_VK extends SelTestCase {
	public static void validate(String searchTerm) throws Exception {
		...
		Thread.sleep(2500);
		sassert().assertTrue(PDP_WL.validateAddToWLGRIsEnabledVK(bundle, ProductID),
				"Add to WL/GR button is not enabled");
		sassert().assertTrue(PDP_cart.validateAddToCartIsEnabled(bundle, ProductID),
